...
# and in the NixOS manual (accessible by running ‘nixos-help’).
{
  ...
  # Garbage Collector so that my poor disk doesn't get polluted
  ...
  # store optimisation automation, instead of nix-store --optimise
  ...
  # Sets up hyprland related configurations
